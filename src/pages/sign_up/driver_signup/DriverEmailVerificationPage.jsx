...
const DriverEmailVerificationPage = () => {
     ...
     const handleContinue = async () => {
          try {
               ...
               if (auth.currentUser.emailVerified) {
                    ...
                    navigate("/sign-up/driver/personal-info");
               } else {
               ...
               <div className="flex flex-col items-center justify-center gap-10 mt-10">
                    <div className="max-w-md  mx-auto p-5 border border-gray-200 rounded-lg text-center space-y-3">
                         ...
                         <button
                              ...
                              className={`w-full py-3 px-4 rounded-md font-medium flex items-center justify-center transition-all duration-200 ${countdown > 0 || isLoading ? 'bg-gray-300 text-white cursor-not-allowed' : 'bg-[#f58000] hover:shadow-xl text-white cursor-pointer'}`}
                         >
                              {isLoading ? (
                                   <>
                    ...
                    <Button variant="contained" onClick={handleContinue} sx={{backgroundColor: "#f58000", borderRadius: 2}}>Continue</Button>
               </div>
          </div>
     );
};

export default DriverEmailVerificationPage;