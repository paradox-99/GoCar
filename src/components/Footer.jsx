...
const Footer = () => {
    return (
        <div className=" bg-[#0e232b] pt-10 pb-5 text-white px-8 md:px-12 lg:px-20">
            <div className="flex flex-col xl:flex-row gap-5 md:justify-between md:items-center">
                ...
                <div className="flex items-center gap-4">
                    <GoMail size={30} className="text-[#f58300]" />
                    <div >
                        <p>Email</p>
                        <p>info@gocar.com</p>
                    </div>
                ...
                <div className="flex ">
                    ...
                    <p className="w-[119px] rounded-r-lg h-10 bg-[#f58300] text-sm flex items-center justify-center">Subscribe</p>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-12 md:gap-20 my-10 lg:flex-row">
                <div className="w-full  lg:w-[500px]">
                    <div className="flex gap-1 items-center">
                        ...
                        <Link to={'/'} className="text-2xl font-bold">goCar</Link>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-6  w-full">
                    ...
                    <div className="mt-3">
                        ...
                        <div className="flex justify-center md:justify-start gap-4 mt-8">
                            <PiFacebookLogoBold className="text-primary text-4xl" />
