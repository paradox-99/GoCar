...
const PaymentHistory = () => {
     ...
     return (
          <div>
               <h1 className="text-4xl text-center mt-8 font-semibold">Payment History</h1>
                                   ...
                                   <TableBody>
                                        {(rowsPerPage > 0
                                             ...
                                             <TableRow key={row.booking_id}>
                                                  ...
                                                  <StyledTableCell>{row.payment_id}</StyledTableCell>
                                                  ...
                                                  <StyledTableCell>{row.payment_date.split('T')[0]}</StyledTableCell>
                                                  <StyledTableCell>{row.Trx_id}</StyledTableCell>
                                             </TableRow>
                                        ))}
                                        {emptyRows > 0 && (
